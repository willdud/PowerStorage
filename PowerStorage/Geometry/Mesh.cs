...
using PowerStorage.Geometry.Meshing.Data;
using PowerStorage.Geometry.Meshing.Iterators;
using PowerStorage.Geometry.Tools;
using PowerStorage.Geometry.Topology;

namespace PowerStorage.Geometry
{
    /// <summary>
    /// Mesh data structure.
    /// </summary>
